...
dataset_name = 'pendulum_expert_v0'
data_filename = dataset_name + '.pkl'

experiment_name = 'bear_'+ dataset_name + '_' + str(BATCH_SIZE) + '_' + str(N_STEPS) + '_seed_' + str(SEED)
...
bear = BEARConfig(batch_size = BATCH_SIZE).create('cuda:0')
